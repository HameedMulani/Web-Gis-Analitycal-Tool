...
<div id="show_files"> 
 ...
 while($row=mysqli_fetch_array($result_set))
 {
  ...
  <form id="frm" method="post" enctype="multipart/form-data" onsubmit='display("<?php echo $fl_id ?>");return false'>
        ...
        <?php echo $row[$r.$i] ?></a>  <button id="<?php echo $fl_id ?>" >plot</button> 
        <button id="<?php echo $i ?>"><img src='icon-delete.png' alt='Remove Item' /></button></label>
        </form>
 ...
 <script>
      ...
      console.log(abc);
      var vtLayer = L.geoJson.vt(abc, options).addTo(map);
